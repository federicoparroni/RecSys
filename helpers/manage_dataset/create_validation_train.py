...
def create_val_train_random(perc):
    with open('./../dataset/masked_sequential_train.csv') as f:
        with open('./../dataset/masked_sequential_our_train.csv', 'w') as csv_file:
...
def create_val_train_random(perc):
    with open('./../dataset/train.csv') as f:
        with open('./../dataset/our_train_seq_random.csv', 'w') as csv_file:
            writer = csv.writer(csv_file)
            writer.writerow(['playlist_id', 'track_id'])
            i = 0
            l = []
