...
# urm = m.create_urm(pd.read_csv('../../raw_data/our_train_random.csv'))
# sp_urm = csr_matrix(urm)
# save_npz('../../raw_data/matrices/sp_urm_MAP_train', sp_urm)

# code for create the test matrix for evaluate the test
sp_urm = load_npz('../../raw_data/matrices/urm.npz')
sp_urm_train = load_npz('../../raw_data/matrices/urm_train.npz')
sp_urm_MAP = sp_urm - sp_urm_train
save_npz('../../raw_data/matrices/sp_urm_MAP_test', sp_urm_MAP)
